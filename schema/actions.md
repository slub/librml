...
Eine `action` des gleichen Typs kann mehrfach aufgeführt werden, wodurch die jeweiligen Einschränkungen disjunkt (nicht exklusiv) zueinander werden [(siehe _Verküpfungen_)](junctions.md).
