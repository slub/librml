...
* Erweiterbarkeit
* Informationssamlung für die Erstellung eines möglichen Anwendungsprofils ([AP 5 Anpassung LibRML](https://wiki.dnb.de/x/VhmpG), [Evaluate the creation of an application profile for digitized objects](https://github.com/slub/librml/issues/92))
