...
Diese Beispiele werden als Fallback genutzt, wenn LibRML aus bestehenden Rechteinformationen abgeleitet wird, wie zum Beispiel im Fall ungültiger Kombinationen (https://github.com/slub/librml/discussions/32) oder Werte (https://github.com/slub/librml/discussions/192). Dies schützt vor unberechtigtem Zugang sowie unbefugter Nutzung digitaler Objekte, weil keine [Nutzungsart](https://librml.org/schema/actions.html) erlaubt ist.
